...
//        let btnFrame = CGRect(x: self.view.frame.size.width - 100, y: self.view.frame.size.height - 80, width: 50, height: 50)
        ...
        cells.append(SectorMenuCell(icon: UIImage(named: "Art")!))
        cells.append(SectorMenuCell(icon: UIImage(named: "Brush")!))
        cells.append(SectorMenuCell(icon: UIImage(named: "Cloud")!))
